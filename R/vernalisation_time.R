...
#' @param x_temp The cardinal temperatures used to calculate vernalisation time. The default values are defined in fababean$get("phenology.vernalisation_time.x").
#' @param y_temp The effective vernalisation time at the corresponding cardinal temperatures. The default values are defined in fababean$get("phenology.vernalisation_time.y").
